...
export const Faq = () => {
  ...
  return (
    <section id="faq" className='px-[90px] relative bg-url([bg]) h-[500px]'>
      <div>
        <h1 className='uppercase text-center text-[28px] mb-4 font-bold'>faq</h1>
        {faqs.map((faq, index) => (
          <div key={index} className='max-w-[900px] w-full mx-auto'>
            <div
              className='flex gap-[5px] pb-[20px] px-[20px] items-center mx-auto justify-center cursor-pointer'
              onClick={() => toggleFAQ(index)}
            >
              <span class="mr-[20px]"><svg width="22px" className={`transition-transform duration-300 fill-white ${openIndex === index ? 'rotate-270' : 'rotate-180'}`} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><g id="Layer_67" data-name="Layer 67"><path d="m35.21 62a2 2 0 0 1 -1.54-.72l-23.21-28a2 2 0 0 1 0-2.55l23.21-28a2 2 0 1 1 3.08 2.55l-22.15 26.72 22.15 26.72a2 2 0 0 1 -1.54 3.28z"></path><path d="m52 62a2 2 0 0 1 -1.54-.72l-23.21-28a2 2 0 0 1 0-2.55l23.21-28a2 2 0 1 1 3.08 2.55l-22.16 26.72 22.16 26.72a2 2 0 0 1 -1.54 3.28z"></path></g></svg></span>
              <button className='text-center text-[16px] sm:text-[18px] cursor-pointer lg:text-[24px]'>
                {faq.question}
              </button>
              <span className='ml-[20px]'>
                <svg width="22px" className={`transition-transform duration-300 fill-white ${openIndex === index ? '-rotate-90' : ''}`} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                  <g id="Layer_67" data-name="Layer 67">
                    <path d="m35.21 62a2 2 0 0 1 -1.54-.72l-23.21-28a2 2 0 0 1 0-2.55l23.21-28a2 2 0 1 1 3.08 2.55l-22.15 26.72 22.15 26.72a2 2 0 0 1 -1.54 3.28z"></path><path d="m52 62a2 2 0 0 1 -1.54-.72l-23.21-28a2 2 0 0 1 0-2.55l23.21-28a2 2 0 1 1 3.08 2.55l-22.16 26.72 22.16 26.72a2 2 0 0 1 -1.54 3.28z">
                    </path>
                  </g>
                </svg>
              </span>
